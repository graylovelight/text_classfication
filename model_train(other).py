...
# 训练模型
model.fit(X_train_subset, y_train_subset, batch_size=128, epochs=10, validation_split=0.15)
...
# 指定保存模型的路径，保存模型
model_path = r'C:\Users\1\Desktop\电子课本\电子书\创新实践\数据集\升级后成果\训练好的模型\model.h5'
